import { Feature, GeoJsonTypes, Position, GeoJSON, Point, BBox, FeatureCollection, Geometry } from 'geojson';
import { MapMouseEvent, MapTouchEvent, Map, MapEvent, FillLayerSpecification, LineLayerSpecification, CircleLayerSpecification, IControl, ControlPosition } from 'mapbox-gl';
...
declare namespace MapboxDraw {
    ...
    interface MapMouseEvent extends MapMouseEvent {
        featureTarget: DrawFeature;
    }

    interface MapTouchEvent extends MapTouchEvent {
        featureTarget: DrawFeature;
    }
